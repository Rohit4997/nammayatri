...
getML stringKey =
    case stringKey of
        ...
        BENGALI -> "বাংলা"
        ENGLISH -> "ഇംഗ്ലീഷ്"
        YOU_HAVE_SUCCESSFULLY_COMPLETED -> "നിനക്ക് വിജയകരമായി പൂർത്തിച്ചിരി"
        ALL_ANSWERS_SHOULD_BE_CORRECT_TO_COMPLETE -> "പൂർത്തിയാകുന്നതിന് എല്ലാ ഉത്തരങ്ങളും ശരിയായിരിക്കണം"
        QUESTIONS_SHOULD_BE_CORRECT_TO_COMPLETE -> "പൂർത്തിയാകുന്നതിന് ചോദ്യങ്ങൾ ശരിയായിരിക്കണം"
        CORRECT -> "ശരി"
        RETAKE_QUIZ -> "ക്വിസ് പുനഃപ്രാരംഭിക്കുക"
        TAKE_A_QUIZ -> "ഒരു ക്വിസ് എടുക്കുക"
        PLAY_AGAIN -> "ആരംഭിക്കുക"
        PLAY_NOW -> "ഇപ്പോൾ കളിക്കുക"
        WATCH_ALL_VIDEOS_TO_LEARN -> "അനുഭവങ്ങൾ നേരിട്ട് കണ്ടുക"
        PLAY_QUIZ_TO_COMPLETE_YOUR_TRAINING -> "നിനക്ക് നിന്നെയായി പൂർത്തിയാക്കാൻ ക്വിസ് കളിക്കുക"
        TRAINING_COMPLETED -> "പ്രശിക്ഷണം പൂർത്തിയായി"
        WATCHED -> "കാണിച്ചിരി"
        UH_OH_SOMETHING_WENT_WRONG -> "ഉഹ്ഹോ! എന്തോ തെറ്റായിരിക്കുന്നു"
        WATCH_ALL_VIDEOS_TO_UNLOCK_QUIZ -> "ക്വിസ് അൺലോക്കുചെയ്യുന്നതിന് എല്ലാ വീഡിയോകൾക്കും കാണുക"
        INCOMPLETE -> "അസമ്പൂർണ്ണമാണ്"
        NEW_C -> "പുതിയത്"
        PENDING_STR_C -> "കാത്തിരിക്കുന്നു"
        COMPLETED_STR -> "പൂർത്തിയായി"
        VIDEOS -> "വീഡിയോകൾ"
        LEARN_AND_EARN -> "പഠിക്കുക കൂടെ സമ്പാദിക്കുക"
