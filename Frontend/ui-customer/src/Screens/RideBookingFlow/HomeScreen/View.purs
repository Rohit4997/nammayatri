...
view push state =
  let showLabel = if DS.null state.props.defaultPickUpPoint then false else true
  in
  frameLayout
    [ height MATCH_PARENT
    , width MATCH_PARENT
       ...
       [ relativeLayout
            ...
            ([ frameLayout
                ...
                , linearLayout
                    ...
                    , accessibility DISABLE
                    , orientation VERTICAL
                    , visibility $ boolToVisibility (os /= "IOS")
                    ]
                    [ imageView
                        [ width $ V 35
                        , height $ V 35
