ALTER TABLE atlas_driver_offer_bpp.merchant_service_usage_config ADD COLUMN driver_verification_service character varying(30);
...
SET driver_verification_service = 'SafetyPortal';
...
SELECT
  m.id,
  moc.id,
  'DriverVerification_SafetyPortal',
  json_build_object(
...
ALTER TABLE atlas_driver_offer_bpp.onboarding_document_configs ADD COLUMN dl_number_verification bool DEFAULT true;
