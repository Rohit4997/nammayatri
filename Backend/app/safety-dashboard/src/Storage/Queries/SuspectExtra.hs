...
findAllByNotFlagStatus :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Domain.Types.Suspect.FlaggedStatus -> m [Domain.Types.Suspect.Suspect]
findAllByNotFlagStatus flaggedStatus = do
  findAllWithOptionsKV
