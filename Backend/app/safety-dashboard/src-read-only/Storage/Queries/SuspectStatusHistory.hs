...
findByPrimaryKey :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Kernel.Types.Id.Id Domain.Types.SuspectStatusHistory.SuspectStatusHistory -> m (Maybe (Domain.Types.SuspectStatusHistory.SuspectStatusHistory))
...
updateByPrimaryKey :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Domain.Types.SuspectStatusHistory.SuspectStatusHistory -> m ()
