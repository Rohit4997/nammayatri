...
type API =
  DashboardAuth 'DASHBOARD_ADMIN :> "add" :> "flagCategory" :> ReqBody '[JSON] API.Types.UI.FlaggedCategory.AddFlagCategoryReq :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
    :<|> DashboardAuth 'DASHBOARD_ADMIN :> "delete" :> "flagCategory" :> ReqBody '[JSON] API.Types.UI.FlaggedCategory.DeleteFlagCategoryReq :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
    :<|> DashboardAuth 'DASHBOARD_USER :> "list" :> "flagCategory" :> QueryParam "limit" (Kernel.Prelude.Int) :> QueryParam "offset" (Kernel.Prelude.Int) :> Get '[JSON] API.Types.UI.FlaggedCategory.FlagCategoryList

handler :: Environment.FlowServer API
handler =
  postAddFlagCategory
    :<|> postDeleteFlagCategory
    :<|> getListFlagCategory
