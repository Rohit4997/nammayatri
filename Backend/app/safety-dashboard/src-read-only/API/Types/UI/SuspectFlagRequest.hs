...
data SuspectApprovalReqList = SuspectApprovalReqList
  { adminApproval :: Domain.Types.SuspectFlagRequest.AdminApproval,
    suspectFlagRequestIdList :: [Data.Text.Text]
  }
  deriving (Generic, ToJSON, FromJSON, ToSchema)

data SuspectFlagRequestList = SuspectFlagRequestList
  { flagRequestList :: [API.Types.UI.SuspectFlagRequest.SuspectFlagRequestResp],
...
data SuspectsApprovalReq = SuspectsApprovalReq
  { adminApproval :: Domain.Types.SuspectFlagRequest.AdminApproval,
    suspectFlagRequestId :: Data.Text.Text
  }
  deriving (Generic, ToJSON, FromJSON, ToSchema)
