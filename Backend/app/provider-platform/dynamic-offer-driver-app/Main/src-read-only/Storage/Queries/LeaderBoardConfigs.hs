...
findLeaderBoardConfigbyType :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Domain.Types.LeaderBoardConfigs.LeaderBoardType -> m (Maybe (Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs))
findLeaderBoardConfigbyType leaderBoardType = do
  findOneWithKV
